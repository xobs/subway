...
module.exports = function(socket, connections) {
  ...
  socket.on('connect', function(data) {
    ...
    if(connection === undefined) {
      connection = new IRCLink(data.username, data.server, data.port, data.secure, data.selfSigned, data.nick, data.realName, data.password, data.rejoin, data.away, data.encoding, data.keepAlive);
